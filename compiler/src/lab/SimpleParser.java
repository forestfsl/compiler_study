...
/**
 * Created by songlin on 2020/4/1.
 */

/*
一个简单的语法解析器https://time.geekbang.org/column/article/120388
能够简单解析简单的表达式。变量声明和初始化语句，赋值语句
它支持的语法规则为：
programm -> intDeclare | expressionStatement | assigmentStatement
        ...
        if (token != null){
            if (token.getType() == TokenType.IntLiteral){
                ...
                if (node != null){
                    ...
                    throw new Exception("expecting an addtive expression in inside parenthesis");
                }
            }
        }
        return node;
            ...
            while (true){//循环应用add规则
                ...
                if (token != null && (token.getType() == TokenType.Plus) || token.getType() == TokenType.Minus){
                    ...
                    if (child2 != null){
                        ...
                        throw  new Exception("invalid addtive expression,expecting the right part.");
                    }
                }else {
                    break;
                }
